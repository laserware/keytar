import { keyEnumByEventKeyTable } from "./tables.js";
import {
  EventButton,
  Modifier,
  MouseButton,
 ...
 */
export function eventToChord(event: KeyboardEvent | MouseEvent): Chord {
 ...
 */
export function eventToChordSet(event: KeyboardEvent | MouseEvent): ChordSet {
